...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pin.siteurl'
        db.add_column(u'core_pin', 'siteurl',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pin.siteurl'
        db.delete_column(u'core_pin', 'siteurl')
    ...
    models = {
        ...
        u'core.pin': {
            ...
            'siteurl': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True'}),
