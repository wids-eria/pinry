...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WhiteListDomain'
        db.create_table(u'core_whitelistdomain', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True)),
        ))
        db.send_create_signal(u'core', ['WhiteListDomain'])


    def backwards(self, orm):
        # Deleting model 'WhiteListDomain'
        db.delete_table(u'core_whitelistdomain')
